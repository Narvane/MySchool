...
public class AddToClassController {
    ...
    public void initialize() {
        classroomName.setText(ClassController.classroomReference);
        System.out.println(ClassController.classroomReference);
        LoadStudents();
        LoadSerieBox();
    ...
    public void Cancel(ActionEvent e) {
        ClassController.addStudentToClass.close();
    }
}
